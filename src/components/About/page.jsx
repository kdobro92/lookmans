    ...
    <div id="about" className="">
      <main>
        <div className="relative z-10 bg-gray-900 pb-20 sm:pb-24 xl:pb-0 h-full flex items-center">
          ...
          <div className="mx-auto flex max-w-7xl flex-col items-center gap-x-8 gap-y-10 px-6 sm:gap-y-8 lg:px-8 xl:flex-row xl:items-stretch mt-200">
            ...
            <div className="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
              <figure className="relative isolate pt-6 sm:pt-12">
                ...
                <figcaption className="mt-8 text-base">
                  <div className="font-semibold text-white">Designer K</div>
                  <div className="mt-1 text-gray-400">Lookman's Hair</div>
                </figcaption>
              </figure>
            </div>
          </div>
